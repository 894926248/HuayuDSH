...
if ([string]::IsNullOrWhiteSpace($TargetPath)) {
  $TargetPath = Join-Path $RepositoryRoot '.workspace\artifacts\active\DeepSeek Harness.exe'
}
if ([string]::IsNullOrWhiteSpace($IconPath)) {
  $IconPath = Join-Path $RepositoryRoot 'product\app\desktop\build\icon.ico'
}
