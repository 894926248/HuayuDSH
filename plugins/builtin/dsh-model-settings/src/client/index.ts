/**
 * Generic model settings and product-onboarding plugin, browser half. It registers
...
export function apply(ctx: ClientContext): void {
  ctx.effect(() => ctx.locale.register(NS, { zh, en }), 'dsh-model-settings: copy dictionaries')
